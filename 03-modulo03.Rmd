...
- to save resources, we would opt to directly use an external SQL client, process data as much as possible on the server side, extract what interests us and only then use **R**;
